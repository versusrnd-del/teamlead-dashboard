	    ...
	    <div class="weekly-showcase showcase-frame ops-showcase">
	      ...
	      <div class="ops-stage">
	        <div class="showcase-outcome">
	          <div class="showcase-kicker">Результат первой линии</div>
	          ...
	          <div class="showcase-kpis">
	            ...
	            <div class="showcase-kpi" style="--accent:#22d3ee"><span>Звонки</span><b>${html(phoneAnsweredText)}</b></div>
	          </div>
	        </div>
	        <div class="ops-control">
	          ...
	          <div class="ops-sla-grid">
	            ...
	            <div class="ops-sla-card"><span>Телефонная линия</span><b>${hasPhoneData ? `${html(Math.round(phoneMissed))}/${html(Math.round(phoneMissedTarget))}` : 'нет данных'}</b><small>пропущено / лимит</small></div>
	      ...
	      <div class="ops-footer">
	        ...
	        <div><span>Телефонная нагрузка</span><b>${hasPhoneData ? `${html(phoneAnsweredText)} звонков · пропущено ${html(Math.round(phoneMissed))}` : 'данные не загружены'}</b></div>
