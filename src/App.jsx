  ...
  return `<!doctype html><html lang="ru"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Постмортем ТОП-1 проблемы</title><style>
    ...
    *{box-sizing:border-box}body{margin:0;background:#eef2f7;color:var(--ink);font-family:Aptos,Calibri,"Segoe UI",Arial,sans-serif;line-height:1.48}.page{max-width:1120px;margin:0 auto;padding:34px 28px 56px}
    ...
    <style>
      ...
      .team-snapshot{display:grid;grid-template-columns:.8fr 1.25fr 1.25fr;gap:0;margin:16px 0;background:#fff;border:1px solid var(--line);border-radius:20px;overflow:hidden;box-shadow:0 12px 28px rgba(15,23,42,.06)}
      ...
      .scale-label{margin-top:16px}.traffic{opacity:.78}.state{padding:8px}.state b{font-size:11px}
    ...
    <div class="team-snapshot">
      ...
      <div class="snapshot-item snapshot-action"><small>3. Что делаем</small><strong>${html(actionNeeded)}</strong><span>${html(checkText)}</span></div>
    </div>
    <div class="kpi">
