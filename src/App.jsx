    ...
    <header class="hero">
      <div class="hero-grid">
        ...
        <div class="meter-grid">
          <div class="pulse"><div class="meter-head"><span>SLA инцидентов</span><em>качество реакции</em></div><div class="orb"></div><div class="pulse-title">${html(currentState.label)}</div><div class="pulse-note">Худший SLA недели: ${html(worstSlaLabel)}. ${html(currentState.note)}.</div><div class="sla-target"><span>Цель процесса</span><b>95%</b></div></div>
